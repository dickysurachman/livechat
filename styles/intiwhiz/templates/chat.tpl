...
<body class="body">
			...
			${if:user}
				${if:canChangeName}
					<div id="changename1" style="display:${page:displ1};">
						...
						<div class="input-name"><input id="uname" type="text" size="12" value="${page:ct.user.name}" class="username"  readonly="readonly"/></div>
	...
	<div id="chat">
		<div class="bgl"><div class="bgr"><div class="sdwbgc"><div class="sdwbgl"><div class="sdwbgr">
			<iframe onload="setTrueHeight();" id="chatwnd" name="chatwnd" src="${if:neediframesrc}${mibewroot}/images/blank.html${endif:neediframesrc}" frameborder="0" style="overflow:scroll;width:100%;">
